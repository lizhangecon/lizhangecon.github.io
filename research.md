...
1. [Directed Technical Change Under Regulation: Evidence from the Chinese Auto Industry](https://lizhangecon.github.io/JMP_LiZhang.pdf) (with [Christian Dustmann](http://www.christiandustmann.com)). _**Job Market Paper**_.
    ...
    <details>
      ...
      <font size = 3>This paper studies the impacts of China's dual-credit policy on the electrification of the auto industry. The policy sets regulatory targets for firms to reduce fuel consumption of vehicles and to produce more electric vehicles (EVs). A Difference-in-Differences analysis shows that the policy reduces the relative price of EVs compared with gasoline vehicles by 38%, shifting demand toward EVs. Decomposing this relative price drop indicates that about one-fourth of the reduction is driven by the performance scores — credits that firms earn and trade under the policy. The implicit subsidies embedded in the credit system also encourage market entry of firms that product high-quality EVs. Changes in the automobile production market further reshape the input market. Firms redirect innovative activities toward EV-related fields and cluster in developed regions with strong EV innovation. These findings highlight that the policy effectively directs technical change toward electrification.</font>
    </details>
